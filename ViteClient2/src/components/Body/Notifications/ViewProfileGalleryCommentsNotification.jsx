...
const ViewProfileGalleryCommentsNotification = ({
    obj,
    item,
    i,
    // authedUser,
...
// }, [viewComments, AddView])
    ...
    return (
        ...
        >
            ...
            {/* {(viewComments && item._id === trackId) && */}
            { item.comments.map((item, i) => {
                // console.log("pre recur map", item)
                return (
                    <div id="comment-comment" className="profileBody"
...
export default ViewProfileGalleryCommentsNotification
